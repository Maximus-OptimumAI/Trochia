...
This file extends `~/.Codex/AGENTS.md` (global). Global rules apply. Project rules override on conflict.
...
| 1 - Knowledge Layer | AI Engineer, Backend Architect, MCP Builder | Codex-api (prompt caching), rag-implementation, embedding-strategies, vector-database-engineer, llm-structured-output |
| 2 - Pitch Lab | AI Engineer, Code Reviewer | Codex-api, llm-structured-output, prompt-engineering-patterns, advanced-evaluation (eval harness from day 1) |
| 3 - Investor Pipeline | AI Engineer, Backend Architect, Identity Graph Operator, Email Intelligence Engineer | Codex-api, linkedin-automation, gmail-automation, rag-implementation |
| 4 - Live Raise | AI Engineer, Voice AI Integration Engineer | Codex-api, llm-structured-output, email-intelligence |
| 5 - Voice Coach | Voice AI Integration Engineer, AI Engineer, UI Designer | voice-ai-development, voice-agents, Codex-api |
| 6 - Data Room | Backend Architect, AI Engineer, Frontend Developer | pdf, docx, xlsx, Codex-api |
...
| 9 - F&F + E-Sign | Backend Architect, Frontend Developer, Compliance Auditor | stripe-integration, Codex-api |
...
*Trochia project AGENTS.md v1 - 2026-05-11. Layered on top of global ~/.Codex/AGENTS.md.*
