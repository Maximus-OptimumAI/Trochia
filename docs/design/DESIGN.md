...
this document. Nav rows and the account trigger use pill radius (`rounded-full`).
Interactive nav rows and the account trigger carry the keyboard focus ring
(`focus-visible:ring-2 ring-ink/40`), reused
